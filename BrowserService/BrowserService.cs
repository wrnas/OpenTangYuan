...
namespace AiApi.Services
{
    ...
    public class BrowserService
    {
        ...
        private readonly IWebHostEnvironment _env;  // 保存 IWebHostEnvironment 实例
        ...
        #region 内部控制器之间使用
        public async Task<BrowserActionResult> ExecuteActionAsync(BrowserSession session, BrowserAction action)
        {
...
() => {
    ...
    return {
        ...
        public  async Task<string> SafeGetTitleAsync(IPage page)
        {
            try
            {
        ...
        /// - data 用于结构化
        /// </summary>
        public BrowserFinalResult BuildFinalResult(List<BrowserActionResult> outputs)
        {
